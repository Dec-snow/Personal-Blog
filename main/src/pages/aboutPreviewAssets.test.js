...
test("keeps the original about site thumbnails on the COS proxy", () => {
  const html = `
    <img src="/cos/about-page/20260624/sites-hoarfrost-3616e0f19f.jpg" alt="hoarfrost.cloud">
    <img src="/cos/about-page/20260624/sites-butterfly-3b2fb61396.jpg" alt="dec-snow.github.io">
    <img src="/cos/about-page/20260624/sites-reimu-a3d1934027.jpg" alt="hoarfrost.cloud/blog">
    <img src="/cos/about-page/20260624/sites-hoarfrost-41ead66835.jpg" alt="hoarfrost.cloud">
  `;

  const rewritten = rewriteAboutPreviewAssets(html);

  assert.match(rewritten, /src="\/cos\/about-page\/20260624\/sites-hoarfrost-3616e0f19f\.jpg"/);
  ...
  assert.match(rewritten, /src="\/cos\/about-page\/20260624\/sites-hoarfrost-41ead66835\.jpg"/);
