...
const GalleryAlbumPage = () => {
  ...
  const staticAlbum = getGalleryAlbum(albumId);
  const [album, setAlbum] = useState(staticAlbum);
  ...
  if (loading) {
    return (
      <div className="relative min-h-screen overflow-hidden bg-[#fff8f1] pt-24 text-[#241322] flex items-center justify-center">
        <p className="text-[#8a7078]">加载中…</p>
      </div>
    );
  }
