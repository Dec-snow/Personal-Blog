...
- [ ] Add a service that runs `python3 /opt/hoarfrost-tools/ai_healthcheck.py run-day`.
- [ ] Add a daily timer with a broad `RandomizedDelaySec`.
- [ ] Add an env example documenting `HOARFROST_AI_COOKIE`, `HOARFROST_AI_ENDPOINT`, `HOARFROST_AI_COUNT`, and `HOARFROST_AI_LOG`.
