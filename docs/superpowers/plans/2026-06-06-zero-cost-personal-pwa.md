...
{
  "name": "hoarfrost",
  "short_name": "hoarfrost",
  "description": "A personal site app for hoarfrost.",
  "start_url": "/",
  "scope": "/",
  "display": "standalone",
...
```js
const CACHE_NAME = "hoarfrost-pwa-v1";
...
<html lang="zh-CN">
  <head>
    ...
    <meta name="apple-mobile-web-app-title" content="hoarfrost" />
```
