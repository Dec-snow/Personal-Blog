...
**Files:**
- Create: `D:\hoarfrost\acg-api\guestbook_messages_test.go`
- Modify: `D:\hoarfrost\acg-api\guestbook_messages.go` (later tasks only)
- Test: `D:\hoarfrost\acg-api\guestbook_messages_test.go`
...
```bash
git -C D:\hoarfrost add acg-api/guestbook_messages_test.go
git -C D:\hoarfrost commit -m "test: cover guestbook threaded replies"
```

### Task 2: Implement backend schema and API support for replies

**Files:**
- Modify: `D:\hoarfrost\acg-api\store.go`
- Modify: `D:\hoarfrost\acg-api\guestbook_messages.go`
- Test: `D:\hoarfrost\acg-api\guestbook_messages_test.go`
...
```bash
git -C D:\hoarfrost add acg-api/store.go acg-api/guestbook_messages.go acg-api/guestbook_messages_test.go
git -C D:\hoarfrost commit -m "feat: add threaded guestbook replies"
```

### Task 3: Add frontend helpers and tests for threading + friends-only filtering

**Files:**
- Create: `D:\hoarfrost\main\src\components\friendsApplicationThreads.js`
- Create: `D:\hoarfrost\main\src\components\friendsApplicationThreads.test.js`
- Modify: `D:\hoarfrost\main\src\services\guestbookMessagesApi.js`
...
```bash
git -C D:\hoarfrost add main/src/components/friendsApplicationThreads.js main/src/components/friendsApplicationThreads.test.js main/src/services/guestbookMessagesApi.js
git -C D:\hoarfrost commit -m "test: cover friends application thread helpers"
```

### Task 4: Rebuild `FriendsApplicationBoard.jsx` into a real comment thread UI

**Files:**
- Modify: `D:\hoarfrost\main\src\components\FriendsApplicationBoard.jsx`
- Modify: `D:\hoarfrost\main\src\services\authApi.js` (only if a small auth helper is needed)
- Use: `D:\hoarfrost\main\src\components\friendsApplicationThreads.js`
...
```bash
git -C D:\hoarfrost add main/src/components/FriendsApplicationBoard.jsx main/src/services/authApi.js
git -C D:\hoarfrost commit -m "feat: add threaded friends application board"
```

### Task 5: Refresh `FriendsPage.jsx` and `index.css` to match the new poetic direction

**Files:**
- Modify: `D:\hoarfrost\main\src\pages\FriendsPage.jsx`
- Modify: `D:\hoarfrost\main\src\index.css`
...
```bash
git -C D:\hoarfrost add main/src/pages/FriendsPage.jsx main/src/index.css
git -C D:\hoarfrost commit -m "feat: refresh friends page atmosphere"
```

### Task 6: Final verification and handoff

**Files:**
- Modify: `D:\hoarfrost\docs\superpowers\specs\2026-06-05-friends-hub-design.md` (only if the implementation intentionally diverges)
- Modify: `D:\hoarfrost\docs\superpowers\plans\2026-06-05-friends-hub-implementation.md` (optional progress updates)
...
```bash
git -C D:\hoarfrost diff --stat
```

- [ ] **Step 5: Commit the final integrated state if everything is green**

```bash
git -C D:\hoarfrost add acg-api main docs/superpowers/specs/2026-06-05-friends-hub-design.md docs/superpowers/plans/2026-06-05-friends-hub-implementation.md
git -C D:\hoarfrost commit -m "feat: add threaded friends applications"
```
