...
**Goal:** Require the existing AI owner login before showing the installable app on `app.hoarfrost.cloud`.
...
- [ ] Verify `app.hoarfrost.cloud` requires owner login and `hoarfrost.cloud` remains public.
