...
- Rewrite the top copy and section framing so it feels like `hoarfrost`'s own in-site voice, with more poetic wording and less product-description tone.
...
- Preserve `hoarfrost`'s own friend-link information in the middle section.
...
Content remains the same canonical four-line friend-link info for `hoarfrost`.
...
When the current logged-in identity is `hoarfrost`, the UI should explicitly surface the identity framing:

- `以 hoarfrost 身份提交友链申请`
...
- `我的友链` presents `hoarfrost`'s four-line info in a copy-friendly card
