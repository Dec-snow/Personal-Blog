---
title: 新博客搭建记——用 Vibe Coding 打造「hoarfrost 创作屋」
...
{% note primary %}
全新个人主页——{% span blue, hoarfrost 创作屋 %}，从零到上线再到架构升级，全程用 **Vibe Coding** 完成。

地址：{% span blue, https://hoarfrost.cloud %}
...
1. **{% span blue, dec-snow.github.io %}** — Hexo + Butterfly 主题，写了近两年
2. **{% span purple, hoarfrost.cloud/blog %}** — Hexo + Reimu 主题，年初刚搭的
...
新站地址：{% span blue, https://hoarfrost.cloud %}
