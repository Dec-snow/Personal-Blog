...
```yaml
social:
  github: https://github.com/Dec-snow
...
**友链页** 加入原博客 dec-snow.github.io 作为友链，命名为「旧版博客」。

### 5. 部署到 Vercel

在 GitHub 新建仓库 `Dec-snow/blog1-reimu`，推送代码。然后在 Vercel 导入该仓库。
...
- **地址：** [hoarfrost.cloud/blog](https://hoarfrost.cloud/blog)
...
原 Butterfly 博客 `https://dec-snow.github.io/` 保持不变，Reimu 博客独立部署在 Vercel，两者互不影响。
...
- {% label 博客仓库 red %}：[Dec-snow/blog1-reimu](https://github.com/Dec-snow/blog1-reimu)
{% endnote %}
