...
excerpt_zh: 这一篇记录主页原创化的一轮重要更新：从参考 GitHub 上的优秀作品出发，逐步保留自己的文案、字体、色调和叙事，再把 Hero、About、Features、Story、Footer 与移动端适配改造成更属于“hoarfrost”的表达。
excerpt_en: This post records an important round of homepage originalization: starting from a great GitHub reference, keeping my own copywriting, typography, colors, and narrative, then reshaping Hero, About, Features, Story, Footer, and mobile behavior into something that feels more like hoarfrost.
words: 6800
reads: 128
minutes: 26
---
...
所以这一轮改造的目标并不是把原来的一切推倒重来，而是在最大程度保留我真正喜欢的高级动态感的基础上，逐步把主页变成更有个人表达、更有“hoarfrost”气质的版本。
...
这些方向并不是每个都成功。  
比如花瓣切换虽然听起来有“hoarfrost”的感觉，但做出来后效果不够自然，反而有点像为了原创而硬加装饰。  
...
| 首页文案 | 有些文案是我自己的 | 保留原创文字与字体 | `WELCOME`、`hoarfrost` 等继续保留 |
...
- [建站成长记录 03｜后端实现：接口、登录、留言板与 AI 助手](https://hoarfrost.cloud/build/post/site-growth-03-backend-services)
...
The goal was to keep the advanced motion and atmosphere I truly liked, while gradually turning the homepage into something with stronger personal expression and a clearer hoarfrost identity.
...
The petal idea sounded fitting for “hoarfrost,” but the actual result felt forced rather than natural.  
...
- my avatar
- the light hoarfrost atmosphere
...
| Homepage copy | some text was already mine | preserve original text and typography | `WELCOME`, `hoarfrost`, and related tone remain |
...
- [Site Growth Log 03 | Backend Implementation for APIs, Login, Guestbook, and the AI Assistant](https://hoarfrost.cloud/build/post/site-growth-03-backend-services)
