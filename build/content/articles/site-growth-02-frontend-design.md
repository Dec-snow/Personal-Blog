...
| 路径 | 作用 |
| --- | --- |
| `https://hoarfrost.cloud/` | 主站 |
| `https://hoarfrost.cloud/blog/` | 主博客 |
| `https://hoarfrost.cloud/build/` | 成长博客 |
...
从仓库里的说明可以直接看出，这个首页经过多次迭代改造，逐步形成了独立的视觉风格。  
...
- [建站成长记录 01｜前提准备：Cloudflare、UCloud 与 NameSilo 的基础搭建](https://hoarfrost.cloud/build/post/site-growth-01-infra-prep)
...
| Path | Purpose |
| --- | --- |
| `https://hoarfrost.cloud/` | Main site |
| `https://hoarfrost.cloud/blog/` | Main blog |
| `https://hoarfrost.cloud/build/` | Growth blog |
...
The repository notes already make that clear: the homepage went through multiple iterations to form its own independent visual style.  
...
- [Site Growth Log 01 | Foundation Setup with Cloudflare, UCloud, and NameSilo](https://hoarfrost.cloud/build/post/site-growth-01-infra-prep)

Next in the series:

- [Site Growth Log 03 | Backend Implementation: APIs, Login, Guestbook, and AI Assistant](https://hoarfrost.cloud/build/post/site-growth-03-backend-services)
