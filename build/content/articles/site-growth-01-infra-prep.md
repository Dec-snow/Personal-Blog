...
| 组件 | 我用它做什么 | 这一层解决的问题 |
| --- | --- | --- |
| `NameSilo` | 购买和持有域名 | 让我拥有 `hoarfrost.cloud` 这个网站地址 |
...
| `https://hoarfrost.cloud/blog/` | Hexo 博客 |
| `https://hoarfrost.cloud/build/` | 成长博客 |
| `https://hoarfrost.cloud/api/` | 后端接口 |
...
- [建站成长记录 02｜前端实现：主站、Hexo 博客与成长博客的页面设计](https://hoarfrost.cloud/build/post/site-growth-02-frontend-design)
...
| --- | --- | --- |
| `NameSilo` | Buying and owning the domain | Gives me control over `hoarfrost.cloud` |
...
| `https://hoarfrost.cloud/blog/` | Hexo blog |
| `https://hoarfrost.cloud/build/` | Growth blog |
| `https://hoarfrost.cloud/api/` | Backend API |
...
- [Site Growth Log 02 | Frontend Implementation: Main Site, Hexo Blog, and Growth Blog Design](https://hoarfrost.cloud/build/post/site-growth-02-frontend-design)
