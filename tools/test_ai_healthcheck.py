...
class AiHealthcheckTests(unittest.TestCase):
    ...
    def test_build_payload_uses_lightweight_fixed_context(self):
        ...
        self.assertEqual(payload["pageUrl"], "https://hoarfrost.cloud/")
    ...
    def test_build_headers_identifies_healthcheck_and_includes_cookie_when_set(self):
        ...
        self.assertEqual(headers["User-Agent"], "hoarfrost-ai-healthcheck")
    ...
    def test_post_healthcheck_sends_expected_request(self):
        ...
        result = ai_healthcheck.post_healthcheck(
            endpoint="https://hoarfrost.cloud/api/chat",
        ...
        request = calls[0][0]
        self.assertEqual(request.full_url, "https://hoarfrost.cloud/api/chat")
        self.assertEqual(request.get_method(), "POST")
        self.assertEqual(request.get_header("User-agent"), "hoarfrost-ai-healthcheck")
