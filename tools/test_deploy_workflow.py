...
class DeployWorkflowTests(unittest.TestCase):
    ...
    def test_deploy_triggers_sync_with_token_header_only(self):
        ...
        self.assertNotIn("curl -sf -X POST --max-time 30 https://hoarfrost.cloud/api/v1/sync/trigger", text)
        self.assertNotIn("curl -i -X POST --max-time 30 https://hoarfrost.cloud/api/v1/sync/trigger || true", text)
        self.assertNotIn("curl -X POST --max-time 30 https://hoarfrost.cloud/api/v1/sync/trigger", text)
        ...
        self.assertIn('curl -sf -X POST --max-time 30 -H "X-Sync-Trigger-Token: $SYNC_TRIGGER_TOKEN" https://hoarfrost.cloud/api/v1/sync/trigger', text)
