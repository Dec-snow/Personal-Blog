#!/usr/bin/env python3
"""Transparent AI healthcheck scheduler for hoarfrost.cloud."""
...
DEFAULT_ENDPOINT = "https://hoarfrost.cloud/api/chat"
DEFAULT_MESSAGE = "请回复 OK，并说明当前服务正常"
DEFAULT_UA = "hoarfrost-ai-healthcheck"
DEFAULT_COUNT = 20
DEFAULT_START = "08:00"
DEFAULT_END = "23:30"
DEFAULT_TIMEOUT = 20
DEFAULT_PAGE_URL = "https://hoarfrost.cloud/"
DEFAULT_LOG = "/var/log/hoarfrost-ai-healthcheck.log"
...
def build_payload(message: str = DEFAULT_MESSAGE) -> dict[str, object]:
    return {
        ...
        "pageContext": {
            ...
            "visibleText": "hoarfrost-ai-healthcheck transparent service probe",
        },
    }
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Transparent hoarfrost AI healthcheck")
    parser.add_argument("--endpoint", default=os.getenv("HOARFROST_AI_ENDPOINT", DEFAULT_ENDPOINT))
    parser.add_argument("--message", default=os.getenv("HOARFROST_AI_MESSAGE", DEFAULT_MESSAGE))
    parser.add_argument("--cookie", default=os.getenv("HOARFROST_AI_COOKIE", ""))
    parser.add_argument("--timeout", type=int, default=_env_int("HOARFROST_AI_TIMEOUT", DEFAULT_TIMEOUT))
    parser.add_argument("--log", default=os.getenv("HOARFROST_AI_LOG", DEFAULT_LOG))
    parser.add_argument("--count", type=int, default=_env_int("HOARFROST_AI_COUNT", DEFAULT_COUNT))
    parser.add_argument("--start", default=os.getenv("HOARFROST_AI_START", DEFAULT_START))
    parser.add_argument("--end", default=os.getenv("HOARFROST_AI_END", DEFAULT_END))
